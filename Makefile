...
# Generated by qmake (3.0) (Qt 5.0.2) on: Fri Jan 31 16:04:32 2014
# Project:  proj.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile proj.pro
#############################################################################
...
SOURCES       = imageGUI.cpp \
		main.cpp \
		image.cpp moc_imageGUI.cpp
OBJECTS       = imageGUI.o \
		main.o \
		image.o \
		moc_imageGUI.o
...
Makefile: proj.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/proj1.0.0 || mkdir -p .tmp/proj1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/proj1.0.0/ && $(COPY_FILE) --parents image.h imageGUI.h .tmp/proj1.0.0/ && $(COPY_FILE) --parents imageGUI.cpp main.cpp image.cpp .tmp/proj1.0.0/ && (cd `dirname .tmp/proj1.0.0` && $(TAR) proj1.0.0.tar proj1.0.0 && $(COMPRESS) proj1.0.0.tar) && $(MOVE) `dirname .tmp/proj1.0.0`/proj1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/proj1.0.0
...
compiler_moc_header_make_all: moc_imageGUI.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_imageGUI.cpp
moc_imageGUI.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
		...
		imageGUI.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) imageGUI.h -o moc_imageGUI.cpp
...
imageGUI.o: imageGUI.cpp imageGUI.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imageGUI.o imageGUI.cpp
...
moc_imageGUI.o: moc_imageGUI.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_imageGUI.o moc_imageGUI.cpp
